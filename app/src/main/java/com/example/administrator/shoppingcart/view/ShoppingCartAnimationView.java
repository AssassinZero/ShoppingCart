package com.example.administrator.shoppingcart.view;
 ...
 * 购物车添加商品动画
 */
public class ShoppingCartAnimationView extends android.support.v7.widget.AppCompatTextView implements ValueAnimator.AnimatorUpdateListener {

package com.example.administrator.shoppingcart;
...
import com.example.administrator.shoppingcart.adapter.ShoppingAdapter;
import com.example.administrator.shoppingcart.datas.AppConfig;
import com.example.administrator.shoppingcart.model.ShoppingModel;
import com.example.administrator.shoppingcart.view.ShoppingCartAnimationView;

import java.util.ArrayList;
import java.util.Iterator;
import java.util.List;

public class MainActivity extends Activity implements ShoppingAdapter.FoodActionCallback {
    private ListView listView;
    private TextView goods_all_pricetv;
    private TextView good_numtv;
    private List<ShoppingModel> list;
    private List<ShoppingModel> selectList = new ArrayList<>();
    ...
    private void initData() {
        ...
        adapter = new ShoppingAdapter(this, list, this);
    ...
    public void addAction(View view, int item) {
        ...
        ShoppingModel model = list.get(item);
    ...
    private void calculatePrice() {
        ...
        double price = 0;
        int num = 0;
        Iterator<ShoppingModel> iterator = list.iterator();
        while (iterator.hasNext()) {
            ShoppingModel model = iterator.next();
            if (model.getNum() != 0) {
